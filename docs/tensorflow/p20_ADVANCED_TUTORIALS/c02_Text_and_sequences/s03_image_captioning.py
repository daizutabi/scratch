...
image_path = os.path.join(os.path.dirname(annotation_zip), name_of_zip)
...
PATH = os.path.dirname(annotation_zip) + "/train2014/"
...
# !padding each vector to the max_length of the captions if the max_length parameter is
# !not provided, pad_sequences calculates that automatically
...
# ## Our images and captions are ready! Next, let's create a tf.data dataset to use for
# ## training our model.
...
# !shape of the vector extracted from InceptionV3 is (64, 2048) these two variables
# !represent that
features_shape = 2048
...
# ## Checkpoint
checkpoint_path = cache_dir("tensorflow/sequences/image_captioning/checkpoints/train")
